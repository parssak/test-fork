...
class TradingEnv(gym.Env):
    ...
    def __init__(self, marketSymbol, startingDate, endingDate, money, stateLength=30,
        ...
        print('marketSymbol: {} \n startingDate: {} \n endingDate: {} \n money: {} \n stateLength: {} \n transactionCosts: {} \n startingPoint: {}'.format(
            marketSymbol, startingDate, endingDate, money, stateLength, transactionCosts, startingPoint))
        print('----------------------------------------------------------------')
        ...
        if(marketSymbol in fictiveStocks):
            ...
            if(marketSymbol == 'LINEARUP'):
                ...
                self.data = stockGeneration.linearDown(
                    startingDate, endingDate)
            elif(marketSymbol == 'SINUSOIDAL'):
                self.data = stockGeneration.sinusoidal(
                    startingDate, endingDate)
            else:
        ...
        # CASE 2: Real stock loading
            ...
            csvName = "".join(['Data/', marketSymbol, '_',
                              startingDate, '_', endingDate])
            ...
            # Otherwise, download the stock market data from Yahoo Finance and save it in the database
                ...
                downloader1 = AlphaVantage()
                downloader2 = YahooFinance()
                try:
    ...
    def render(self):
        ...
        plt.savefig(
            ''.join(['Figures/', str(self.marketSymbol), '_Rendering', '.png']))
        # plt.show()
